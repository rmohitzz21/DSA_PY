#1-->DEFINE CLASS NODE 
#2-->DEFINE DLL WITH __INIT__() METHOD TO CREATE AND INITIALISE START REFERENCE VAR.
#3--> DEFINE METHOD IS_EMPTY() 
#4-->DEFINE INSERT_AT_START()
#5-->DEFINE INSERT_AT_LAST()
#6-->DEFINE METHOD SEARCH()
#7-->DEFINE INSERT_AFTER()
#8-->DEFINE METHOD TO PRINT ALL THE STATEMENTS
#9-->IMPLEMENT ITERATOR FOR DLL TO ACCESS ALL ELEMENTS OF THE LIST 
#10-->DEFINE DELETE_FIRST()
#11-->DEFINE DELETE_LAST()
#12-->DEFINE DELTE_ITEM()
